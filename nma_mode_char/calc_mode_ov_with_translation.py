...
if __name__ == '__main__':
    ...
    for t,f in files:
        ...
        c_ov = cumulative_overlap(open_to_vopen, _eigenvectors)
        print t, "w open to v. open", c_ov
        c_ov = cumulative_overlap(open_to_vclosed, _eigenvectors)
        print t, "w open to v. closed", c_ov
        
        c_ov = cumulative_overlap(closed_to_vopen, _eigenvectors)
        print t, "w closed to v. open", c_ov
        c_ov = cumulative_overlap(closed_to_vclosed, _eigenvectors)
        print t, "w closed to v. closed", c_ov
